/*
  twoDisplays4Dig8Dig.ino - Example file to demonstrate TM74HC595LedTube class use with two displays simultaneously
...
// TM74HC595LedTube myLedDispTwo(dsp2Sclk, dsp2Rclk, dsp2Dio, true, 4);
TM74HC595LedTube myLedDispTwo(dsp2Sclk, dsp2Rclk, dsp2Dio, true, 8);
...
{
  testNum = firstTest - 1;
  myLedDispTwo.setDigitsOrder(diyMore);
}
...
void loop()
{
  ...
  if ((millis() - timer) >= testTime)
  {
    ...
    case -3:
      ...
      testResultTwo = myLedDispTwo.print("Here You");
      break;
    case -2:
      testResultOne = myLedDispOne.print("thiS");
      testResultTwo = myLedDispTwo.print("See the");
      break;
    case -1:
      testResultOne = myLedDispOne.print("teSt");
      testResultTwo = myLedDispTwo.print("dIFF.POSS");
      break;
    case 0:
      ...
      testResultTwo = myLedDispTwo.print("See You");
      break;
    case 1:
      ...
      testResultTwo = myLedDispTwo.print("Later");
      break;
    case 2:
